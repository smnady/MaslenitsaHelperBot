...
public enum Command implements Descriable {
    ...
    public static final class Message {
        ...
        static final String GREETINGS = """
                ...
                Я здесь, чтобы помочь вам сделать празднование Масленицы незабываемым! Вы найдете различные рецепты блинов, а также сможете узнать все о играх на Масленицу и точное их описание.
